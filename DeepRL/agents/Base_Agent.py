...
class Base_Agent(object):
    ...
    def turn_on_any_epsilon_greedy_exploration(self):
        ...
        self.turn_off_exploration = False
        self.logger.info("Turned on epsilon greedy exploration.")
    ...
    def turn_off_any_epsilon_greedy_exploration(self):
        ...
        self.logger.info("Turned off epsilon greedy exploration.")
    ...
    def freeze_all_but_output_layers(self, network):
        ...
        for param in network.named_parameters():
            param_name = param[0]
            assert "hidden" in param_name or \
                   "output" in param_name or \
                   "embedding" in param_name, "Name {} of network layers not understood".format(param_name)

            if "output" not in param_name:
                param[1].requires_grad = False

        self.logger.info("Froze hidden layers.")
    ...
    def unfreeze_all_layers(self, network):
        ...
        self.logger.info("Unfroze hidden layers.")
